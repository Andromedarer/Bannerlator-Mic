...
public enum Binding {
    ...
    public static String[] keyboardBindingLabels() {
        ...
        for (Binding binding : values()) {
            if (binding.isKeyboard() || binding == SHOW_ANDROID_KEYBOARD) labels.add(binding.toString());
        }
    ...
    public static Binding[] keyboardBindingValues() {
        ...
        for (Binding binding : values()) {
            if (binding.isKeyboard() || binding == SHOW_ANDROID_KEYBOARD) values.add(binding);
        }
