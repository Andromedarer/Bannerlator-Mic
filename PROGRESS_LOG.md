...
## 2026-08-08 — 🔕 **Silent session (game/container-launch) notification** (branch `fix/silent-session-notification` off main `93d6c0af`, commits `4ec7b31a`+`ef296bcd`, CI run `31270319429` GREEN, vc 69 / 2.9.7, NOT on main, artifacts-only)
