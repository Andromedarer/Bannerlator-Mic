...
Bannerlator stands on a huge amount of open-source work. Thank you to:

**Upstream projects & runtimes**
- **[Winlator](https://github.com/brunodev85/winlator)** (Bruno Kholl) — the foundation this is built on.
- **WinNative** — controller/input-ring hardening (#603) and other input work adapted here (GPL-3.0).
- **GameNative** — Epic/store plumbing, download model and HUD patterns referenced for parity.
- **Pluvia** & **[JavaSteam](https://github.com/Longi94/JavaSteam)** (in.dragonbra) — Steam session and depot-download foundations.
- **Goldberg / gbe_fork** — Steam emulation.
- **[DXVK](https://github.com/doitsujin/dxvk)**, **[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton)**, **D7VK** — Direct3D → Vulkan translation.
- **[FEX-Emu](https://github.com/FEX-Emu/FEX)**, **Box64 / wowbox64** — x86/x64 emulation.
- **Wine / Proton** and **[GE-Proton](https://github.com/GloriousEggroll/proton-ge-custom)** (GloriousEggroll) — the Windows runtime.
- **[Mesa](https://gitlab.freedesktop.org/mesa/mesa) / Turnip / Zink**, **adrenotools** — the graphics driver stack.
- **AMD FidelityFX FSR3** (MIT) — the optical-flow front-end behind win-fg.
- **PulseAudio / ALSA** and **[DirectAudio](https://github.com/The412Banner/directaudio)** (LGPL-2.1) — the audio stack.
- **ReShade**, **vkBasalt**, **lsfg-vk** — post-processing and frame generation.

**Community contributors & testers**
- PR contributors **@clintOnSky** (#96) and **@isygold** (#84), and **Charan** for the Mali/BCn work.
- Issue reporters this cycle and before — **@Mr-Teal** (#380), **@kylinzang** (#71, #73), **@abdogm** (#44), **@SombraShadow** (#66), **@Devaspe**, and everyone who filed a report and tested a build. A pre-release only works because of you.

_If your work belongs here and isn't listed, that's an oversight, not an omission — please open an issue and it'll be added._
